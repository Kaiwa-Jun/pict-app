<template>
  <div class="container my-4">
    <h1 class="headword">利用規約</h1>

    <div class="row">
      <div class="column is-8 is-offset-2 my-2">
        <h2 class="subtitle">利用規約</h2>
    <p>この利用規約（以下，「本規約」といいます。）は，PICTREAL（以下，「当事務局」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>

    <h2 class="subtitle">第1条（適用）</h2>
    <ol>
    ...
    <h2 class="subtitle">第3条（ユーザーIDおよびパスワードの管理）</h2>
    <ol>
    ...
    <h2 class="subtitle">第5条（本サービスの提供の停止等）</h2>
    <ol>
      <li>
    ...
    <h2 class="subtitle">第6条（利用制限および登録抹消）</h2>
    <ol>
      <li>
    ...
    <h2 class="subtitle">第7条（退会）</h2>
    <p>ユーザーは，当事務局の定める退会手続により，本サービスから退会できるものとします。</p>

    <h2 class="subtitle">第8条（保証の否認および免責事項）</h2>
    <ol>
